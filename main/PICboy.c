...
// memory arrays
#ifdef PICBOY_EMBEDDED
unsigned char *gb_mem_rom = NULL; // pointer to externally-owned ROM buffer
#else
			...
			case 0x01:
			{
				if (gb_cart_enable_ram > 0)
				{
					...
					else
					{
						...
						return gb_mem_eram[(gb_cart_bank_addr & 0x7FFF)];
					}
				}
				else
				{
			...
			case 0x01:
			{
				if (gb_cart_enable_ram > 0)
				{
					...
					else
					{
						...
						gb_mem_eram[(gb_cart_bank_addr & 0x7FFF)] = val;
					}
				}
				else
				{
